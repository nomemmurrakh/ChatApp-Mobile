...
import RegisterOneForm from "@/components/ui/register/RegisterOneForm";
...
export default function HomeScreen() {
  ...
  const onSubmit = (values: Form.RegisterOneValues) => {
  ...
  return (
    <KeyboardAvoidingView behavior={"padding"} style={styles.container}>
      ...
      >
        ...
        <RegisterOneForm loading={false} onSubmit={onSubmit} />
